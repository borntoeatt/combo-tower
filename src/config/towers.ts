...
/** Final-level specialization: stat multipliers applied at max level. */
export interface SpecDef {
  readonly name: string;
  readonly desc: string;
  readonly dmgM?: number;
  readonly rateM?: number;
  readonly rangeM?: number;
  readonly splashM?: number;
  readonly slowM?: number;      // multiplies the slow factor — lower = colder
  readonly slowDurM?: number;
  readonly poisonM?: number;
  readonly poisonDurM?: number;
  readonly chainAdd?: number;
...
export interface TowerDef {
  ...
  readonly specs: readonly [SpecDef, SpecDef]; // max-level branch choice
}
...
export const TOWER_TYPES: Readonly<Record<TowerTypeId, TowerDef>> = {
  gunner: { name: "Gunner", key: "1", cost: 50,  range: 120, rate: 3.2, dmg: 8,
            ...
            specs: [
              { name: "Minigun",   desc: "+60% fire rate", rateM: 1.6 },
              { name: "AP Rounds", desc: "pierces armor",  pierce: true, dmgM: 1.15 },
            ] },
  cannon: { name: "Cannon", key: "2", cost: 100, range: 135, rate: 0.75, dmg: 30,
            ...
            specs: [
              { name: "Heavy Shells", desc: "+60% damage", dmgM: 1.6 },
              { name: "Wide Blast",   desc: "+50% splash", splashM: 1.5 },
            ] },
  frost:  { name: "Frost",  key: "3", cost: 70,  range: 110, rate: 1.5, dmg: 4,
            ...
            specs: [
              { name: "Deep Freeze", desc: "slows 70%",        slowM: 0.6 },
              { name: "Blizzard",    desc: "+35% range, +40% chill", rangeM: 1.35, slowDurM: 1.4 },
            ] },
  venom:  { name: "Venom",  key: "4", cost: 90,  range: 125, rate: 1.1, dmg: 6,
            ...
            specs: [
              { name: "Virulence", desc: "+80% poison dps", poisonM: 1.8 },
              { name: "Lingering", desc: "poison lasts 2x", poisonDurM: 2 },
            ] },
  tesla:  { name: "Tesla",  key: "5", cost: 130, range: 130, rate: 1.3, dmg: 18,
            ...
            specs: [
              { name: "Superconductor", desc: "chains +2",   chainAdd: 2 },
              { name: "High Voltage",   desc: "+50% damage", dmgM: 1.5 },
            ] },
  sniper: { name: "Sniper", key: "6", cost: 150, range: 330, rate: 0.5, dmg: 60,
            ...
            specs: [
              { name: "Railgun",   desc: "+70% damage",    dmgM: 1.7 },
              { name: "Quickdraw", desc: "+70% fire rate", rateM: 1.7 },
            ] },
};
